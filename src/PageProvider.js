...
exports.PageProvideByPath = exports.PageProvideByPort = exports.changeIndexHtmlCss = exports.getWebViewContent = void 0;
 ...
 */
function changeIndexHtmlCss(context, vscodeColorTheme) {
    // web index页面样式
...
exports.changeIndexHtmlCss = changeIndexHtmlCss;
function PageProvideByPort(name, port, route) {
    const PORT = port;
    const ROUTE = route;
...
exports.PageProvideByPort = PageProvideByPort;
function PageProvideByPath(context, pageName, pagePath) {
    const panel = vscode.window.createWebviewPanel(pageName, pageName, vscode.ViewColumn.One, {
...
exports.PageProvideByPath = PageProvideByPath;
