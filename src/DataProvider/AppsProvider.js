...
exports.AppsProvider = exports.AppKind = void 0;
const vscode = require("vscode");
const path = require("path");
class AppKind extends vscode.TreeItem {
    constructor(label, collapsibleState, command) {
        ...
        this.contextValue = 'Application Kind';
    }
}
exports.AppKind = AppKind;
class AppsProvider {
    ...
    getChildren(element) {
        this.appKinds = [];
        var imgApp = new AppKind("数字图像识别", vscode.TreeItemCollapsibleState.None, {
