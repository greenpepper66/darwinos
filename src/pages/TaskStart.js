...
exports.getTaskInputHtml = void 0;
 ...
 * @returns
 */
function getTaskInputHtml(context, templatePath) {
...
exports.getTaskInputHtml = getTaskInputHtml;
module.exports = function (context) {
    context.subscriptions.push(vscode.commands.registerCommand('task_view.startTask', function (uri) {
        const panel = vscode.window.createWebviewPanel('taskWelcome', // viewType
        "task", // 视图标题
